...
function App() {
  ...
  const exportSecurityData = () => {
    ...
    downloadFile(rawData, `Abinara_RawLogs_${timestamp}.json`);
    downloadFile(incidentData, `Abinara_SecurityIncidents_${timestamp}.json`);
    downloadFile(intelData, `Abinara_ThreatIntel_${timestamp}.json`);
  };
  ...
  return (
    <div className="dashboard-layout">
            ...
            <div className="glass-panel">
              ...
              {events.length === 0 ? (
                ...
                <table className="table-container">
                    ...
                    <tbody>
                    {[...events].sort((a,b) => new Date(b.timestamp) - new Date(a.timestamp)).slice(0, 50).map((event, i) => (
      ...
      <AIChatAssistant isOpen={isChatOpen} setIsOpen={setIsChatOpen} onExport={exportSecurityData} />
    </div>
  );
}
...
function AIChatAssistant({ isOpen, setIsOpen, onExport }) {
