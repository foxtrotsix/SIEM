        ...
        {activeTab === 'dashboard' && (
          <>
            <div className="grid-stats">
              ...
              <StatCard icon={<Activity />} label="Log Flow" value="12 ops/s" />
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '1.5rem', marginBottom: '2rem' }}>
              <div className="glass-panel">
                <h3 style={{ marginBottom: '1.5rem', color: '#f1f5f9' }}>Alert Trends (24h)</h3>
...
const mockChartData = [
  { name: '00:00', value: 400 }, { name: '04:00', value: 300 }, { name: '08:00', value: 200 },
  { name: '12:00', value: 278 }, { name: '16:00', value: 189 }, { name: '20:00', value: 239 },
  { name: '23:59', value: 349 }
];

const mockBarData = [
  { name: '192.168.1.45', value: 120 },
  { name: '10.0.0.8', value: 98 },
  { name: '172.16.5.12', value: 86 },
  { name: '45.78.12.3', value: 72 },
  { name: '192.168.1.102', value: 65 }
];
